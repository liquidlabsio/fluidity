...
public class AvgHistoAggregator extends AbstractHistoAggregator {

    public AvgHistoAggregator(Map<String, InputStream> inputStreams, Search search) {
    ...
    public boolean isForMe(String analytic) {
        return analytic.equals("analytic.avg()");
    }

    @Override
    public HistoAggregator clone(Map<String, InputStream> inputStreams, Search search) {
        return new AvgHistoAggregator(inputStreams, search);
    }
