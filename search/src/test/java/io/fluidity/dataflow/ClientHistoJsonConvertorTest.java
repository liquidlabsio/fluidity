...
class ClientHistoJsonConvertorTest {
    ...
    void toFromJson() {
        ...
        byte[] jsonBytes = new ClientHistoJsonConvertor().toJson(stats);
        TimeSeries<FlowStats> newTimeSeries = new ClientHistoJsonConvertor().fromJson(jsonBytes);
        byte[] checkingJson = new ClientHistoJsonConvertor().toJson(newTimeSeries);
